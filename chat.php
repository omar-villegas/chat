...
function chatHeartbeat() {
	...
	$sql = "select * from chat where (chat.to = 'General') order by id ASC";
...
EOD;
	...
	$sql = "update chat set recd = 1 where chat.to = 'General' and recd = 0";
	$query = mysqli_query(mysqli_connect("localhost", "root", "", "chat"),$sql);
...
EOD;
	...
	$sql = "insert into chat (chat.from,chat.to,message,sent) values ('". $from ."', 'General','" . $message ."',NOW())";
	$query = mysqli_query(mysqli_connect("localhost", "root", "", "chat"),$sql);
	echo "1";
	exit(0);
}
